...
pdbs_to_staple = sorted(
    glob.glob('/home/broerman/crispy_shifty/projects/crispy_shifty_dimers/round_2/af2/mpnn_redesigns/af2_models/*A_*.pdb') + \
    glob.glob('/home/broerman/crispy_shifty/projects/crispy_shifty_dimers/round_2/af2/mpnn_redesigns/af2_models/*[!A]B_*.pdb') + \
    glob.glob('/home/broerman/crispy_shifty/projects/crispy_shifty_dimers/round_2/af2/mpnn_redesigns/split_Y/*.pdb')
)
...
for pdb in pdbs_to_staple:
    ...
    for i, crosslinked_pose in enumerate(the_native_disulfide_stapler.apply(pose)):
        crosslinked_pose.dump_pdb(os.path.join('/home/broerman/crispy_shifty/projects/crispy_shifty_dimers/round_2/disulfides/mpnn_redesigns/staples', f'{pdb_filename}_staple_{i}.pdb'))
